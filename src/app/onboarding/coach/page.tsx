    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-br from-indigo-200/20 to-purple-200/20 rounded-full blur-3xl"
        />
      </div>
                  ...
                  >
                    ...
                    {isActive && (
                      <motion.div
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
                        className="absolute -inset-2 bg-purple-200 rounded-full opacity-30 animate-pulse"
                      />
                    )}
                  </motion.div>
                  {step < totalSteps && (
                    <div className={`w-12 sm:w-24 h-0.5 mx-1 transition-all duration-300 ${
      ...
      <div className={`relative z-10 px-4 sm:px-6 lg:px-8 pb-8 transition-all duration-1000 delay-400 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}>
        <div className="max-w-2xl mx-auto">
          ...
          >
            {/* Header */}
            <div className="bg-gradient-to-r from-purple-500 via-indigo-500 to-blue-500 px-6 sm:px-8 py-6">
              <div className="text-center text-white">
                ...
                <h1 className="text-2xl sm:text-3xl font-bold mb-2">Complete Your Coach Profile</h1>
                <p className="text-purple-100 text-sm sm:text-base">Set up your coaching profile to start managing athletes</p>
              </div>
            </div>
              ...
              <form onSubmit={handleSubmit}>
                <AnimatePresence mode="wait">
                  ...
                  {currentStep === 1 && (
                    ...
                    >
                      <div className="text-center mb-6">
                        ...
                        <p className="text-gray-600">This will be displayed to your athletes and in your coaching profile</p>
                      </div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-12 pr-4 py-4 border-2 border-gray-200 rounded-xl focus:border-purple-500 focus:ring-0 transition-all duration-200 text-lg placeholder-gray-400 bg-gray-50 focus:bg-white"
                  ...
                  {currentStep === 2 && (
                    ...
                    >
                      <div className="text-center mb-6">
                        <h2 className="text-xl font-semibold text-gray-900 mb-2">Select your academy</h2>
                        <p className="text-gray-600">This helps athletes find and connect with you</p>
                      </div>
                      ...
                      <div className="relative">
                        ...
                        <select
                          ...
                          onChange={handleInputChange}
                          className="w-full pl-12 pr-4 py-4 border-2 border-gray-200 rounded-xl focus:border-purple-500 focus:ring-0 transition-all duration-200 text-lg bg-gray-50 focus:bg-white"
                          required
                        >
                        ...
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            <h3 className="text-sm font-semibold text-blue-900 mb-2">
                              🏏 Ready to Coach Athletes
                            </h3>
                            <p className="text-sm text-blue-700 leading-relaxed">
                              After completing your profile, you'll be able to:
                            </p>
                            <ul className="mt-2 text-sm text-blue-700 space-y-1">
                              <li>• Invite and manage athletes from your academy</li>
                              <li>• Track their progress with detailed analytics</li>
                              <li>• Create custom training programs and feedback</li>
                              <li>• Monitor skill development and match performance</li>
                            </ul>
                          </div>
                        </div>
                      </div>
